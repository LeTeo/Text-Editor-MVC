...
namespace TextEditorMVC
{
    public class MainPresenter
    {
        ...
        public void _view_ContentChanged(object sender, EventArgs e)
        {
            string content = _view.Content;
            int count = _manager.GetSymbolCount(content);
            _view.setSymbolCount(count);
        }
        public void _view_FileOpenClick(object sender, EventArgs e)
        {
            try
            {
        ...
        public void _view_FileSaveClick(object sender, EventArgs e)
        {
            try
            {
                string content = _view.Content;
